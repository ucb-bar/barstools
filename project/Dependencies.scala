...
object Dependencies {
  val scalatestVersion = sys.props.getOrElse("scalatestVersion", "2.2.5")
  val scalatest = "org.scalatest" %% "scalatest" % scalatestVersion % "test"
  val scalacheckVersion = sys.props.getOrElse("scalacheckVersion", "1.12.4")
  val scalacheck = "org.scalacheck" %% "scalacheck" % scalacheckVersion % "test"

  // Templating!
  val handlebarsVersion =  sys.props.getOrElse("handlebarsVersion", "2.1.1")
